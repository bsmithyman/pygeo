...
# ----------------------------------------------------------------------
cpdef orientation (object im_o, gfsize=1):
  '''
  ...
  cdef _np.ndarray[F64_t, ndim=2] g0sq, gmul, g1sq, item, gradsamp, gradsdiff, im = im_o
...
cpdef wkf (im, imor):
  ...
  cdef _np.ndarray[F64_t, ndim=2] mar, par
